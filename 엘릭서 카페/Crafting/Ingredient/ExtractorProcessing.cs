...
//추출기 가공 스크립트
public class ExtractorProcessing : MonoBehaviour
{
    [SerializeField] private GameObject panel; //추출기 가공 UI 패널 오브젝트
    public Ingredient[] ingredients;           //가공 할 수 있는 재료 목록 (증류수, 탄산수)
